...
const METRIC_REGISTRY = {
    ...
    {"metric_key":"kovaak.miss_count","source":"kovaak","concept":"performance","category":"session","unit":"count","data_type":"integer","higher_is_better":false,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_miss_count","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"外した回数。実ファイル 3.9.8 のフッターで確認。"},
    {"metric_key":"kovaak.total_overshots","source":"kovaak","concept":"precision","category":"session","unit":"count","data_type":"integer","higher_is_better":false,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_total_overshots","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"撃ちすぎの回数。"},
    {"metric_key":"kovaak.reloads","source":"kovaak","concept":"context","category":"session","unit":"count","data_type":"integer","higher_is_better":null,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_reloads","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"リロード回数。"},
    {"metric_key":"kovaak.mbs_points","source":"kovaak","concept":"performance","category":"session","unit":"score","data_type":"number","higher_is_better":true,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_mbs_points","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"KovaaK 内のポイント。意味未確認。"},
    {"metric_key":"kovaak.time_remaining","source":"kovaak","concept":"context","category":"session","unit":"s","data_type":"number","higher_is_better":null,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_time_remaining","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"シナリオの残り時間。"},
    {"metric_key":"kovaak.pause_count","source":"kovaak","concept":"context","category":"session","unit":"count","data_type":"integer","higher_is_better":null,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_pause_count","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"一時停止した回数。実測で 2 を確認。"},
    {"metric_key":"kovaak.pause_duration","source":"kovaak","concept":"context","category":"session","unit":"s","data_type":"number","higher_is_better":null,"layer":"normalized","metric_version":"1","comparability_group":"kovaak_pause_duration","recommendation_eligible":false,"reliability_policy":{"status":"unrated","reason":"value_confirmed_but_policy_not_set","note":"実ファイル（3.9.8）で値と単位を確認済み。意味・正規化・reliability policy の確定待ち。"},"normalization_method":"none","description":"一時停止の合計秒数。実測で 65 を確認。"}
    ]
};
/* METRICS:END */
